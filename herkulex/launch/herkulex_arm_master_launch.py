...
def generate_launch_description():
	...
	# HerkuleX arm
    herkulex_arm_master_node = Node(
        package='herkulex',
        executable='herkulex_arm_master_node',
        name='herkulex_arm_master_node',
        output='screen'
    )
    ...
    [
    	herkulex_arm_master_node,
        
        DeclareLaunchArgument(
            'port',
            default_value='/dev/ttyUSB1', #'/dev/HerkuleX'
